...
public abstract class JacksonUtils {
	 ...
	 * @return
	 */
	public static <T> T unmarshal(String content, Class<T> targetType) throws UnexpectedException {
	...
	public static <T> T unmarshal(byte[] content, Class<T> targetType) throws UnexpectedException {
		if (content == null) {
			return null;
		}
		try {
	 ...
	 * @return
	 */
	public static <T> T unmarshal(String content, Class<T> targetType, Class<?>... parameterTypes) throws UnexpectedException {
		if (StringUtils.isBlank(content)) {
			return null;
		}
	 ...
	 * @return
	 */
	public static <T> T unmarshal(String content, T beanToUpdate) throws UnexpectedException {
		try {
	 ...
	 * {@link JacksonUtils#marshalNonDefault(Object)},
	 * {@link JacksonUtils#marshalNonEmpty(Object)},
	 * {@link JacksonUtils#marshalNonNull(Object)}等方法控制所有属性的这些行为。
	 *
	 * @param obj
	 *            给定的java对象
	 * @return 序列化后的JSON字符串
	 ...
	 * @return
	 */
	public static String marshalNonNull(Object obj) throws UnexpectedException {
		try {
	 ...
	 * @return
	 */
	public static String marshalNonDefault(Object obj) throws UnexpectedException {
		try {
	 ...
	 * @return
	 */
	public static String marshalNonEmpty(Object obj) throws UnexpectedException {
		try {
	 ...
	 * @return
	 */
	public static String marshalToJSONP(String functionName, Object obj) throws UnexpectedException {
