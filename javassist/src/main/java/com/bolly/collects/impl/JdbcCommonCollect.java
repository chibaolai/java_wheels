...
import com.bolly.model.JdbcStatistics;
 ...
 * @author bolly
 */
public class JdbcCommonCollect extends AbstractByteTransformCollect implements ICollect {

    public static JdbcCommonCollect INSTANCE;
    private ApmContext context;

    public JdbcCommonCollect(Instrumentation instrumentation, ApmContext context) {
    ...
    static {
        // connect
        beginSrc = "com.bolly.collects.impl.JdbcCommonCollect inst=com.bolly.collects.impl.JdbcCommonCollect.INSTANCE;";
    ...
    public Connection proxyConnection(final Connection connection) {
        Object c = Proxy.newProxyInstance(JdbcCommonCollect.class.getClassLoader()
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            try {
                if (isTargetMethod) { // 获取PreparedStatement 开始统计
                    jdbcStat = (JdbcStatistics) JdbcCommonCollect.this.begin(null, null);
                ...
                JdbcCommonCollect.this.error(jdbcStat, e);
                JdbcCommonCollect.this.end(jdbcStat);
                throw e;
            }
            return result;
        }
